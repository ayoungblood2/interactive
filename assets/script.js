...
console.log("this is avery's website. things i need to fix: mouse position, ticker tape responsive, margin bottom text consistency, unicode eyes appear if no activity, more images when clicking or hovering over preview img, are.na cms for images, custom website email, different custom domain, two column info/about box, timestamp")
